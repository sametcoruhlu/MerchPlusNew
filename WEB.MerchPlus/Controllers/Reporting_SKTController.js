(function () {
    ...
    $(function () {
        console.log("Hello, IIFE loaded for Reporting SKT Controller module. Let's get dirty...");
        PrepareDatePickers();
    ...
    function GenerateReport() {
        ...
        var url = InfrastructureVariables.WebServicePath + "api/ReportingController/SKTRaporu";
        var data = {};
